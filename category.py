...
class categoryclass:
    def __init__(self,root):
        ...
        lbl_name=Label(self.root,text="Enter Category",font=("goudy old style",18),bg="white",fg="black").place(x=50,y=100)

        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",20),bg="lightyellow",fg="black").place(x=50,y=170,width=300)
