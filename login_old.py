...
class Login_Sysytem:
    def __init__(self,root):
        ...
        txt_employee_id=Entry(login_frame,textvariable=self.employee_id,font=("times new roman",15),bg="#ECECEC",fg="black").place(x=50,y=140,width=250)
        ...
        lbl_reg=Label(register_frame,text="Pharmacy Management System",font=("times new roman",13),bg="white",fg="black").place(x=0,y=20,relwidth=1)
