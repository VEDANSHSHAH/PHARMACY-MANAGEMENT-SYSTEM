...
def create_db():
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS medicine(m_id INTEGER PRIMARY KEY AUTOINCREMENT,Name text,Company text,Type text,Price text,Quantity text,Manufacturing_Date text,Expiry_Date text,pass text)")
    con.commit()
