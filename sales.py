...
class salesclass:
    def __init__(self,root):
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("times new roman",15,"bold"),bg="lightgray",cursor="hand2",fg="black").place(x=490,y=100,width=120,height=28)
        #================bill list
        ...
        #==============images===================
        self.bill_photo=Image.open("images/phone.png")
        self.bill_photo=self.bill_photo.resize((500,250),Image.ANTIALIAS)
