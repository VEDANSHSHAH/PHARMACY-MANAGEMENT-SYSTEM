...
class employeeClass:
    def __init__(self,root):
        ...
        #====search frame=====
        SearchFrame=LabelFrame(self.root,text="Search Employee",font=("goudy old style",12,"bold"),bd=2,relief=RIDGE,bg="white",fg="black")
        ...
        txt_search=Entry(SearchFrame,textvariable=self.var_searchtxt,font=("goudy old style",15,),bg="lightyellow",fg="black").place(x=200,y=10)
        btn_search=Button(SearchFrame,text="Search",command=self.search,font=("goudy old style",15,),bg="#4caf50",fg="black").place(x=410,y=9,width=150,height=30)

        #===title==
        title=Label(self.root,text="Employee Details",font=("goudy old style",15),bg="#0f4d7d",fg="black").place(x=50,y=100,width=1000)
        ...
        cmb_gender=ttk.Combobox(self.root,textvariable=self.var_gender,values=("Select","Male","Female","Others"),state='readonly',justify=CENTER,font=("times new roman",15))
        ...
        lbl_pass=Label(self.root,text="Password",font=("goudy old style",15),bg="white",fg="black").place(x=350,y=230)
    ...
    def search(self):
        ...
        try:
            if self.var_searchby.get()=="Select":
                messagebox.showerror("Error","Select search by otion",parent=self.root)
