...
class productclass:
    def __init__(self,root):
        ...
        txt_name=Entry(product_Frame,textvariable=self.var_name,bg="lightyellow",fg="black").place(x=200,y=160,width=200)
        txt_price=Entry(product_Frame,textvariable=self.var_price,bg="lightyellow",fg="black").place(x=200,y=210,width=200)
        txt_qty=Entry(product_Frame,textvariable=self.var_qty,bg="lightyellow",fg="black").place(x=200,y=260,width=200)
        ...
        btn_add=Button(product_Frame,text="ADD",command=self.add,font=("goudy old style",10),bg="#2196f3",fg="black",cursor="hand2").place(x=10,y=400,width=100,height=40)
        ...
        btn_delete=Button(product_Frame,text="DELETE",command=self.delete,font=("goudy old style",10),bg="#2196f3",fg="black",cursor="hand2").place(x=230,y=400,width=100,height=40)
        btn_clear=Button(product_Frame,text="CLEAR",command=self.clear,font=("goudy old style",10),bg="#2196f3",fg="black",cursor="hand2").place(x=340,y=400,width=100,height=40)
        ...
        self.product_table.heading("pid",text="MED ID")
